...
namespace Terrain {
    ...
    public List<List<float>> resource_map = new List<List<float>>();
        ...
        public TerrainMapHandler(Vector2 map_size, int elevation_strategy, int land_strategy, int region_strategy, int features_strategy){
        ...
        public void GenerateShores(List<HexTile> hex_list){
