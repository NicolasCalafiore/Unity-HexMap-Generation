...
using UnityEngine;
using Players;
using static Terrain.MapGeneration;
...
namespace Terrain {
    ...
    public class TerrainMapHandler
    {
        ...
        WaterStrategy strategy = null;
            ...
            this.ocean_map = strategy.GenerateWaterMap(map_size, EnumHandler.HexRegion.Ocean);
            this.river_map = strategy.GenerateWaterMap(map_size, EnumHandler.HexRegion.River);
