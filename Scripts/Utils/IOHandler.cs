...
public static class IOHandler{
    ...
    public static List<string> ReadPrefixNamesRegionSpecified(string filePath, string region)
    {
       XDocument doc = XDocument.Load(filePath);
    ...
    public static List<string> ReadStateNamesRegionSpecified(string filePath, string region)
    {
    XDocument doc = XDocument.Load(filePath);
